    ...
    try {
      if (isSessionActive) {
        ...
        const firstMessage = sessionData?.character
          ...
          : "You step through a glowing portal, colors flashing around you. The barrier ripples and parts. A shimmering figure appears, its voice soft. Greetings, traveler. Saludos. Go aisatsu. Abhivaadan. This is a world between worlds. What is your name, and what path do you choose?";
